...
def single_views(request, pid):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            comments.save()
            messages.add_message(request, messages.SUCCESS, 'Yor Commets submited successfully')
        else:
            messages.add_message(request, messages.ERROR, 'Yor Commets dident submited.')
    form = commentForm()
